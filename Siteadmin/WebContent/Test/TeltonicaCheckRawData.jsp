...
try{
	...
	c= DriverManager.getConnection("jdbc:mysql://203.199.134.130/db_avlalldata","site","1@s2te");
...
<input type="radio" name="limit" value="All" > All
	...
	//	String sqlUnitTyp = "select * from db_gps.t_unitmaster where unitid='"+unitid+"'";
		...
		sqlProcessed="SELECT Body,status,storedtime FROM t_peopletracker"+thedate2+"Processed   where Unitid='"+imei+"'  group by storedtime   order by storedtime desc "+limit;
