...
{	
	 String SqlUpdate="UPDATE db_gps.t_imeidetails  SET Status ='Deactive' WHERE unitid='"+id+"' limit 1 ";
	System.out.println(">>>>>>>>SqlDeleteMaster:"+SqlUpdate);
	stmt1.executeUpdate(SqlUpdate);
	
	String SqlUpdate1="UPDATE db_gps.t_imeidetailsHistory SET Status ='No' WHERE unitid='"+id+"' limit 1 ";
