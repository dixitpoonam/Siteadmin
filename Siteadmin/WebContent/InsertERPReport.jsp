...
try{
	...
	String sql="select PageName from twsql_twalldata.t_reportnumber where PageName='"+pageName+"'";
	...
	{
	String sqlInsert="INSERT INTO twsql_twalldata.t_reportnumber (ReportName,PageName,ActiveStatus,EnteredBy) VALUES "+
